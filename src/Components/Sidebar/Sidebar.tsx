...
export const Sidebar = (props: SidebarProps) => {
  return (
    <div className="h-full banner">
      ...
      <div className="p-4">
        <ul>
          <li className="mb-5 li-active-container">
          ...
          <li className="mb-5 li-container">
            <div className="mb-2 inline-flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28"
          ...
          <li className="mb-5 li-container">
            <div className="mb-2 inline-flex items-center">
              ...
              >
                <path
                  d="M13.9542 3.74048C5.88744 3.74048 3.19775 6.43016 3.19775 14.4969C3.19775 22.5636 5.88744 25.2533 13.9542 25.2533C22.0209 25.2533 24.7106 22.5636 24.7106 14.4969"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M22.7081 5.54294C22.4335 5.3 22.1136 5.11357 21.7669 4.9943C21.4201 4.87502 21.0533 4.82525 20.6873 4.84782C20.3213 4.87039 19.9634 4.96486 19.6339 5.12584C19.3044 5.28681 19.0099 5.51113 18.7672 5.78598C18.7672 5.78598 13.6867 11.5247 11.9273 13.5166C10.1679 15.5086 11.4622 18.2576 11.4622 18.2576C11.4622 18.2576 14.3693 19.1797 16.1136 17.211L22.9581 9.48153C23.4472 8.92606 23.6956 8.19907 23.6487 7.46046C23.6018 6.72186 23.2635 6.03211 22.7081 5.54294Z"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M17.4531 7.28833L21.6394 10.9897"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
          ...
          <li className="mb-5 li-container">
            <div className="mb-2 inline-flex items-center">
              ...
              >
                <path
                  d="M12.4249 14.0721C12.4249 14.4982 12.2985 14.9148 12.0616 15.269C11.8248 15.6233 11.4881 15.8993 11.0944 16.0622C10.7006 16.225 10.2673 16.2674 9.84942 16.1839C9.43154 16.1005 9.04781 15.8949 8.74681 15.5932C8.44581 15.2916 8.24106 14.9074 8.15849 14.4894C8.07592 14.0713 8.11923 13.6381 8.28295 13.2447C8.44666 12.8513 8.72342 12.5152 9.07819 12.2791C9.43296 12.0431 9.84979 11.9175 10.2759 11.9185C10.8464 11.9194 11.3932 12.1467 11.7961 12.5505C12.199 12.9544 12.4252 13.5016 12.4249 14.0721Z"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M12.433 14.072H19.7799V16.2256"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M3.19775 14.0721C3.19775 6.00536 5.88744 3.31567 13.9542 3.31567C22.0209 3.31567 24.7106 6.00536 24.7106 14.0721C24.7106 22.1388 22.0209 24.8285 13.9542 24.8285C5.88744 24.8285 3.19775 22.1388 3.19775 14.0721Z"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
          ...
          <li className="mb-5 li-container">
            <div className="mb-2 inline-flex items-center">
              ...
              >
                ...
                />
                <path
                  d="M2.67456 14.6903C2.67456 6.1991 5.50611 3.36755 13.9973 3.36755C22.4884 3.36755 25.32 6.1991 25.32 14.6903C25.32 23.1814 22.4884 26.013 13.9973 26.013C5.50611 26.013 2.67456 23.1814 2.67456 14.6903Z"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
          ...
          <li className="mb-5 li-container">
            <div className="mb-2 inline-flex items-center">
              ...
              >
                <path
                  d="M13.9507 3.31555C8.79347 3.31555 6.55382 7.98441 6.55382 11.0718C6.55382 13.3789 6.88872 12.6998 5.6119 15.5139C4.05252 19.5246 10.3226 21.163 13.9507 21.163C17.5788 21.163 23.8478 19.5234 22.2896 15.5139C21.0104 12.6998 21.3476 13.3789 21.3476 11.0718C21.3476 7.98441 19.1057 3.31555 13.9507 3.31555Z"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
                ...
                />
                <path
                  d="M16.6358 24.2446C16.3094 24.6411 15.8993 24.9605 15.4348 25.1797C14.9704 25.3989 14.4632 25.5126 13.9496 25.5126C13.436 25.5126 12.9288 25.3989 12.4644 25.1797C12 24.9605 11.5898 24.6411 11.2634 24.2446"
                  stroke="black"
                  stroke-width="1.19608"
                  stroke-miterlimit="10"
                  stroke-linecap="round"
