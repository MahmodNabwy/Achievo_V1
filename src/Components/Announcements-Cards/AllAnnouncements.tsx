import "./AnnouncementsCards.scss";
export const AllAnnouncements = () => {
  return (
    <div className="AnnouncementsCards w-full">
      <div className="grid grid-cols-2 lg:grid-cols-2 w-full pt-4 gap-4">
        ...
        <div className="col-span-full  announcements-card">
          <div
            className="flex justify-between h-full"
            style={{
              borderLeft: "26px solid #FFC1004D",
              borderRadius: "7px",
              justifyContent: "space-between",
            }}
          >
            ...
            <div className="dates-info-read flex justify-center pt-4">
              <div>
                <p className="dates-content">24-05-2023</p>
